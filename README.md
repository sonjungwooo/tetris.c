# tetris.c
단국대학교부속소프트웨어고등학교 5기로 만들어준 프로그램

## 개발동기
성공과 실패를 경험하면서 C언어로 나만의 게임을 꼭 만들고 싶다 마음먹고 테트리스 게임 만들기를 시작하게 되었습니다. 개발하게 된 계기는 아빠의 어린시절 최애 게임인 테트리스를 만들어 달라는 인생 첫 주문을 받았기 때문입니다
 
## 개발언어 및 개발도구
